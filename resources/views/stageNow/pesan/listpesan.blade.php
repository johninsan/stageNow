                ...
                <table class="table table-hover table-striped">
                  ...
                  @else
                    ...
                    <tr>
                      ...
                      @endforeach
                      <td class="mailbox-subject"><a href="{{route('pesan.show', $pesans->kode) }}"> @foreach(\App\acara::where('id',$pesans->acara_id)->get() as $acara) <b>{{ $acara->judul }}</b> @endforeach - {{ substr($pesans->pesan,0,30) }} [...]</a>
                      </td>
                      <td class="mailbox-attachment"></td>
