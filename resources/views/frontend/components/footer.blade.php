    ...
    <div class="container">
        ...
        <div class="row footer-top">
            ...
            <div class="col-md-3">
                ...
                <p>StageNow, cari musisi impianmu, melalui StageNow..</p>

                <p class="contact_info"><i class="icon icon-pin-map"></i> Politeknik Negeri Jakarta, Depok, Jawa Barat, Indonesia</p>

                <p class="contact_info"><i class="icon icon-email-envelope"></i> <a href="mailto:contact@email.com">stageNow@pnj.ac.id</a></p>
